...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ImagenBanner: Attribute.Media;
    titulo: Attribute.String;
    Articulo: Attribute.Component<'articulo.articulo'>;
...
export interface ApiCasoCaso extends Schema.SingleType {
  ...
  attributes: {
    textoBanner: Attribute.RichText;
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::caso.caso', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::caso.caso', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiConsultaConsulta extends Schema.SingleType {
...
export interface ApiConsumidorConsumidor extends Schema.SingleType {
  collectionName: 'consumidors';
  info: {
    singularName: 'consumidor';
    pluralName: 'consumidors';
  ...
  attributes: {
    ...
    tituloUno: Attribute.String;
    tarjetas: Attribute.Component<'card.card', true>;
    cloud: Attribute.Component<'section.section', true>;
    tituloDos: Attribute.String;
    textoDos: Attribute.RichText;
    stepper: Attribute.Component<'stepper.stepper', true>;
    tituloTres: Attribute.String;
    textoTres: Attribute.RichText;
    form: Attribute.Component<'form.form'>;
    cloudDos: Attribute.Component<'section.section'>;
    tituloCuatro: Attribute.String;
    accordion: Attribute.Component<'accordion.accordion', true>;
    textoAccordionBottom: Attribute.String;
    iconStepperOnly: Attribute.Media;
    secondClass: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::consumidor.consumidor',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    ...
    tituloContent: Attribute.String;
    parrafo: Attribute.RichText;
    tarjeta: Attribute.Component<'card.card', true>;
    subtituloDos: Attribute.String;
    titluloSegundo: Attribute.String;
    segundoContenido: Attribute.RichText;
    tarjetaSection: Attribute.Component<'card.card', true>;
    section: Attribute.Component<'section.section'>;
    tituloTres: Attribute.String;
    contenidoTres: Attribute.RichText;
    tarjetasTres: Attribute.Component<'card.card', true>;
    textoDesc: Attribute.RichText;
    sectionCuatro: Attribute.Component<'section.section'>;
    carrusel: Attribute.Component<'carrusel.carrusel'>;
    stepper: Attribute.Component<'stepper.stepper', true>;
    titleStepper: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiNosotroNosotro extends Schema.SingleType {
  ...
  attributes: {
    bannerDos: Attribute.Component<'banner-dos.banner-dos'>;
    tituloUno: Attribute.String;
    textoUno: Attribute.RichText;
    cards: Attribute.Component<'card.card', true>;
    cloud: Attribute.Component<'section.section'>;
    textFooterCard: Attribute.RichText;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSobreNosotroSobreNosotro extends Schema.SingleType {
  collectionName: 'sobre_nosotros';
  info: {
    singularName: 'sobre-nosotro';
    pluralName: 'sobre-nosotros';
    displayName: 'DatosPersonal';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::caso.caso': ApiCasoCaso;
      'api::category.category': ApiCategoryCategory;
      'api::consulta.consulta': ApiConsultaConsulta;
      'api::consumidor.consumidor': ApiConsumidorConsumidor;
